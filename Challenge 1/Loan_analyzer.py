...
print(f"The sum of the loans is: ${sum_of_loans}")

# Calculating the average using the sum of all loans and the total number of loans.
...
print(f"The remaining months is: {remaining_months} months")


# Using the formula for Present Value to calculate a "fair value" of the loan.
...
# Writing a conditional statement (an if-else statement) to decide if the present value represents the loan's fair value.
...
# Defining a new function that will be used to calculate and return the present value.

def cal_present_value(future_value, remaining_months, annual_discount_rate):
    present_value = future_value/(1+(annual_discount_rate/12))**remaining_months
    return present_value

# Using the function to calculate the present value of the new loan given below.
#    Use an `annual_discount_rate` of 0.2 for this new loan calculation.
future_value = 1000
remaining_months = 12
annual_discount_rate = 0.20
present_value = cal_present_value(future_value, remaining_months, annual_discount_rate)
